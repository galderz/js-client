...
NODE_DOWNLOAD_ROOT=http://rcm-guest.app.eng.bos.redhat.com/rcm-guest/staging/jboss-dg/node/
NPM_DOWNLOAD_ROOT=http://rcm-guest.app.eng.bos.redhat.com/rcm-guest/staging/jboss-dg/node/npm/
...
main() {
    ...
    MVN_GOAL="$MVN_GOAL -DnodeDownloadRoot=${NODE_DOWNLOAD_ROOT} -DnpmDownloadRoot=${NPM_DOWNLOAD_ROOT}"
